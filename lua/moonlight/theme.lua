...
theme.loadSyntax = function ()
    ...
    local syntax = {
        ...
        String =                    { fg = moonlight.green, bg = moonlight.none, style= 'none' }, -- Any string
        ...
        Todo =                        { fg = moonlight.yellow, bg = moonlight.none, style = 'bold,none' }, -- anything that needs extra attention; mostly the keywords TODO FIXME and XXX
    ...
    if vim.g.moonlight_italic_comments == 'true' then
        syntax.Comment =        {fg = moonlight.comments, bg = moonlight.none, style = 'none'} -- italic comments
    else
    ...
    if vim.g.moonlight_italic_keywords == 'true' then
        syntax.Conditional =        {fg = moonlight.purple, bg = moonlight.none, style = 'none'} --  if, then, else, endif, switch, etc.
        syntax.Keyword =            {fg = moonlight.purple, bg = moonlight.none, style = 'none'} --  for, do, while, etc.
        syntax.Repeat =                {fg = moonlight.purple, bg = moonlight.none, style = 'none'} --  any other keyword
    else
    ...
    if vim.g.moonlight_italic_functions == 'true' then
        syntax.Function =        {fg = moonlight.blue, bg = moonlight.none, style = 'none'} -- italic funtion names
    else
        syntax.Function =        {fg = moonlight.blue} -- normal function names
    end

    if vim.g.moonlight_italic_variables == 'true' then
        Identifier =                {fg = moonlight.gray, bg = moonlight.none, style = 'none'}; -- any variable name
    else
...
theme.loadEditor = function ()
    ...
    local editor = {
        ...
        Folded =                { fg = moonlight.disabled, bg = moonlight.none, style = 'none' },
        FoldColumn =            { fg = moonlight.blue },
        IncSearch =                { fg = moonlight.highlight, bg = moonlight.dark_blue, style = 'reverse' },
        ...
        SpellCap =                { fg = moonlight.blue, bg = moonlight.none, style = 'none,undercurl' },
        SpellLocal =            { fg = moonlight.cyan, bg = moonlight.none, style = 'none,undercurl' },
        SpellRare =                { fg = moonlight.purple, bg = moonlight.none, style = 'none,undercurl' },
        ...
        DashboardFooter =                       { fg = moonlight.green, style = "none" },
...
theme.loadTreeSitter = function ()
    ...
    -- Italic comments
    if vim.g.moonlight_italic_comments == 'true' then
        treesitter.TSComment=                  { fg = moonlight.comments , bg = moonlight.none, style = 'none' }    -- For comment blocks.
    else
        treesitter.TSComment=                  { fg = moonlight.comments }    -- For comment blocks.
    end

    if vim.g.moonlight_italic_keywords == 'true' then
        treesitter.TSConditional =             { fg = moonlight.purple, style = 'none' }    -- For keywords related to conditionnals.
        treesitter.TSKeyword =                 { fg = moonlight.purple, style = 'none' } -- For keywords that don't fall in previous categories.
        treesitter.TSRepeat =                  { fg = moonlight.purple, style = 'none' }    -- For keywords related to loops.
        treesitter.TSKeywordFunction =         { fg = moonlight.purple, style = 'none' } -- For keywords used to define a fuction.
    else
    ...
    if vim.g.moonlight_italic_functions == 'true' then
        treesitter.TSFunction =                { fg = moonlight.blue, style = 'none' }    -- For fuction (calls and definitions).
        treesitter.TSMethod =                  { fg = moonlight.blue, style = 'none' }    -- For method calls and definitions.
        treesitter.TSFuncBuiltin =             { fg = moonlight.cyan, style = 'none' }    -- For builtin functions: `table.insert` in Lua.
    else
    ...
    if vim.g.moonlight_italic_variables == 'true' then
        treesitter.TSVariable =                { fg = moonlight.gray, style = 'none' } -- Any variable name that does not have another highlight.
        treesitter.TSVariableBuiltin =         { fg = moonlight.gray, style = 'none' } -- Variable names that are defined by the languages, like `this` or `self`.
    else
...
theme.loadPlugins = function()
    ...
    local plugins = {
        ...
        WhichKeyDesc =                          { fg = moonlight.blue, style = 'none' },
